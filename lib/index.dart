...
export '/auth/onboading_start_page/onboading_start_page_widget.dart'
    show OnboadingStartPageWidget;
export '/auth/auth_page_add_phone/auth_page_add_phone_widget.dart'
    show AuthPageAddPhoneWidget;
