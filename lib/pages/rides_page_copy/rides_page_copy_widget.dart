                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            ...
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  ...
                                                                                  color: functions.dayJSONtracksCount(containerTraksByDayResponse.jsonBody).toString() == '0' ? FlutterFlowTheme.of(context).secondaryText : FlutterFlowTheme.of(context).primaryText,
                                                                                  fontSize: 16.0,
                                                                                  letterSpacing: 0.0,
                                                                                                ...
                                                                                                Row(
                                                                                                  ...
                                                                                                  children: [
                                                                                                    ...
                                                                                                    Text(
                                                                                                      ...
                                                                                                      style: FlutterFlowTheme.of(context).bodySmall.override(
                                                                                                            fontFamily: FlutterFlowTheme.of(context).bodySmallFamily,
                                                                                                            color: dailyListViewItem.isFraud ? FlutterFlowTheme.of(context).secondaryText : FlutterFlowTheme.of(context).primaryText,
                                                                                                            fontSize: 14.0,
                                                                                                            letterSpacing: 0.0,
                                                                                                            fontWeight: FontWeight.w500,
                                                                                                            useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).bodySmallFamily),
